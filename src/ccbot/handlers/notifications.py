"""Outbound assistant message routing from SessionMonitor.

handle_new_message delivers Claude Code JSONL updates to the correct
Telegram topic via thread_bindings and the per-user message queue.
"""
