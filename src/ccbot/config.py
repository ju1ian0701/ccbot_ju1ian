...
class Config:
    ...
    def __init__(self) -> None:
        ...
        raw_lang = os.getenv("CCBOT_WHISPER_LANGUAGE", "auto").strip().lower()
        if raw_lang not in ("auto", "en", "ru"):
            logger.warning(
                "Unknown CCBOT_WHISPER_LANGUAGE=%r, defaulting to 'auto'",
                raw_lang,
            )
            raw_lang = "auto"
        self.whisper_language: str = raw_lang
